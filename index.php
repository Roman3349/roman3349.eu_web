...
<html lang='cs'>
    <head>
        ...
        <title>Roman Ondráček</title>
    </head>
    <body>
        <header>
            <h1>Roman Ondráček</h1>
            <h2>Student, programátor, kodér</h2>
        </header>
        <nav>
            <ul>
                <li><a href='/'>O mně</a></li>
                <li><a href='#co-umim'>Co umím</a></li>
        ...
        <section>
            ...
            <article>
                <p>Vítejte na mém webu. Jmenuji se Roman Ondráček a je mi 16 let. Jsem kodér, programátor a student 
                    ...
                    a naleznete mě tam pod přezdívkou Roman3349.</p>
            </article>
            <header id="co-umim">Co umím</header>
            <article>
